  ...
  return (
    <div className="py-2">
      <h2>
        ...
        >
          <span className='font-rope'>{title}</span>
          <svg className="fill-brand-600 shrink-0 ml-8" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div className="overflow-hidden">
          <p className="pb-3 text-left font-rope">
            {children}
          </p>
        </div>
      </div>
